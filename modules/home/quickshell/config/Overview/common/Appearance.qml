...
Singleton {
    ...
    property QtObject defaultColors: QtObject {
        ...
        property color m3primary: '#ff0909'
        property color m3onPrimary: '#ff0505'
        property color m3primaryContainer: '#f10000'
        property color m3onPrimaryContainer: '#ff0000'
        property color m3secondary: '#ffffff'
        property color m3onSecondary: '#ff0000'
        property color m3secondaryContainer: '#ff0000'
        property color m3onSecondaryContainer: '#ff0000'
        property color m3background: '#0B1119'
        property color m3onBackground: '#ff0000'
        property color m3surface: '#ff0000'
        property color m3surfaceContainerLow: '#242B34'
        property color m3surfaceContainer: '#d3ffffff'
        property color m3surfaceContainerHigh: '#ff0000'
        property color m3surfaceContainerHighest: '#ff0000'
        property color m3onSurface: '#ff0000'
        property color m3surfaceVariant: '#ff0000'
        property color m3onSurfaceVariant: '#ffffff'
        property color m3inverseSurface: '#242B34'
        property color m3inverseOnSurface: '#ffffff'
        property color m3outline: '#ffffff'
        property color m3outlineVariant: '#ffffff'
    ...
    colors: QtObject {
        ...
        property color colLayer0Border: ColorUtils.mix(root.m3colors.m3outlineVariant, colLayer0, 1.0)
